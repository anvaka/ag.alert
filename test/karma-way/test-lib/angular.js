/**
 * @license AngularJS v1.2.6-build.local+sha.b0474cb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.b0474cb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.b0474cb',    // all of these placeholder strings will be replaced by grunt's
